...
ALTER TABLE INSTRUCTOR_INFO
ADD CONSTRAINT ZIP_INSTRUCTOR_FK FOREIGN KEY(ZIP_CODE) REFERENCES ZIPCODE_INFO(ZIP_CODE);
...
ALTER TABLE ENROLLMENT_INFO
ADD SECTION_ID NUMERIC(8,0) NOT NULL;
...
ALTER TABLE GRADE_INFO
ALTER COLUMN NUMERIC_GRADE NUMERIC(3,0) NOT NULL;
...
ALTER TABLE GRADE_INFO
ADD CONSTRAINT GRADE_STUDENT_ID_FK FOREIGN KEY(STUDENT_ID) REFERENCES STUDENT_INFO(STUDENT_ID);

ALTER TABLE GRADE_INFO
ADD CONSTRAINT GRADE_SECTION_ID_FK FOREIGN KEY(SECTION_ID) REFERENCES SECTION_INFO(SECTION_ID);

ALTER TABLE GRADE_INFO
ADD CONSTRAINT CHK_GRADE_TYPE_CODE CHECK (GRADE_TYPE_CODE IN ('FI','HM','MT','PA','PJ','QZ'));

ALTER TABLE GRADE_INFO
ADD CONSTRAINT NUMERIC_GRADE_NN DEFAULT 0 FOR NUMERIC_GRADE;